...
2.If the heap size exceeds k, remove the smallest element (which is the root of the min-heap). 
...
# Explanation:
# Heap of size k: The heap is kept at size k. 
# This way, the smallest element in the heap (root of the min-heap) 
# is always the smallest among the k largest elements found so far.
