...
The time complexity is O(m+n) where m and n are the lengths of the two linked lists respectively. 
Ignoring the space consumption of the answer linked list, the space complexity is O(1)
'''
